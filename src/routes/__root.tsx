...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://sjmsystems.it/__l5e/assets-v1/bd93b0f0-43d5-4ee4-bfef-d5293b50c091/social-card.jpg" },
      ...
      { name: "twitter:image", content: "https://sjmsystems.it/__l5e/assets-v1/bd93b0f0-43d5-4ee4-bfef-d5293b50c091/social-card.jpg" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [
      {
